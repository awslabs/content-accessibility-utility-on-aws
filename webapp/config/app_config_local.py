...
class Config:
    ...
    def __init__(self):
        ...
        self._s3_bucket = os.environ.get(self.S3_BUCKET_KEY) or os.environ.get(
            self.S3_BUCKET_ALT_KEY
        )
        self._bda_project_arn = os.environ.get(
            self.BDA_PROJECT_ARN_KEY
        ) or os.environ.get(self.BDA_PROJECT_ARN_ALT_KEY)
    ...
    def get_conversion_options(
        self, extract_images: bool, image_format: str, multiple_documents: bool
    ) -> Dict[str, Any]:
        """
