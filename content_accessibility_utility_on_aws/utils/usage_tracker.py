...
class SessionUsageTracker:
    ...
    def track_bedrock_call(
        ...
        logger.debug(
            f"Tracked Bedrock call: model={model_id}, purpose={purpose}, input_tokens={input_tokens}, output_tokens={output_tokens}"
        )
    ...
    def track_bda_processing(
        ...
        logger.debug(
            f"Tracked BDA processing: document={document_id}, pages={page_count}"
        )
